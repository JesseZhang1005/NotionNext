...
export const getPasswordQuery = path => {
  ...
  if (queryParams.password) {
    ...
    sessionStorage.setItem('password_default', queryParams.password)
  }
  ...
  const storedPassword = sessionStorage.getItem('password_' + cleanedPath)
  const defaultPassword = sessionStorage.getItem('password_default')
