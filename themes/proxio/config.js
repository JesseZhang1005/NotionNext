...
const CONFIG = {
  ...
  PROXIO_HERO_TITLE_1: 'Jesse Space', // 英雄区文字
  PROXIO_HERO_TITLE_2: '您可以点击下载作品集，也可以在主页中观看', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  PROXIO_HERO_BUTTON_1_TEXT: '联系我', // 英雄区按钮
  ...
  PROXIO_FEATURE_1_ICON_IMG_URL: 'https://pub-95f1bd15e36b49d4a02e331faec2b866.r2.dev/Images/Angie_touxiang.png', // 图片图标选填，默认是fas图标，如果需要图片图标可以填写图片地址，示例/avatar.png
  ...
  PROXIO_FEATURE_BUTTON_URL: '/resume', // 按钮跳转
  ...
  PROXIO_CTA_TITLE: 'Contact Jesse',
  PROXIO_CTA_TITLE_2: '感谢观看',
